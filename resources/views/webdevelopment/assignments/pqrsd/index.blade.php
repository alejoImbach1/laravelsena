...
<form action="{{ route('pqrsd.store') }}" class="w-full px-5 py-2" method="POST" enctype="multipart/form-data">
    ...
    <div class="w-100 datos-personales">
        <label>
            ...
            Primer nombre
            <br>
            <input type="text" name="first_name" placeholder="Ejemplo: Juan" value="{{ old('first_name') }}"
                required>
        </label>
        <label>
            Segundo nombre
        ...
        <label>
            ...
            Primer apellido
            <br>
            <input type="text" name="first_surname" placeholder="Ejemplo: Juan" value="{{ old('first_surname') }}"
                required>
        </label>
        <label>
            Segundo apellido
